...
.status-tag.archived_in_d1 { background-color: #8e44ad; } /* Purple for archived */
...
.status-message.success { background-color: #2ecc71; color: white; } /* Style for success messages */

.archived-message { /* Specific style for the archived message */
    margin-bottom: 30px;
    font-size: 1.2em;
    font-weight: bold;
}
